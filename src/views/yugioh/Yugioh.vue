            ...
            <template #form>
                ...
                <div class="form-main">
                    ...
                    <el-form ref="form" :model="form" label-width="auto" size="small">
                        ...
                        <el-form-item label="HP" v-if="['monster','pendulum'].includes(form.type)">
                            <el-input-number v-model="form.hp" :min="-1" :max="9999" :precision="0"></el-input-number>
